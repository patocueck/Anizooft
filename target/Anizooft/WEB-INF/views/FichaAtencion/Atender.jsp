...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Atender Consulta Médica</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form:form action="/Anizooft/FichaAtencion/Atender" modelAttribute="atencion" method="post">
	                                ...
	                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                            				...
                            				<div class="form-group">
												...
												<form:textarea path="consultadiagnostico" class="form-control script-obligatorio" />
