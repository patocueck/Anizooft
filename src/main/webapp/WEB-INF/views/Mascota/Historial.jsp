	                            ...
	                            <div class="row">
	                                <div class="col-lg-10">
                                        ...
                                        <div class="form-group">
	                                       	<div class="col-lg-4">
	                                        	<label>Año Inicio</label>
	                                           	<select name="anoIni" class="form-control">
                                       	...
                                       	<div class="col-lg-4">
	                                    	<div class="form-group">
	                                        	<label>Mes Inicio</label>
	                                           	<select name="mesIni" class="form-control">
                                       	...
                                       	<div class="col-lg-4">
	                                   		<div class="form-group">
	                                        	<label>Día Inicio</label>
	                                           	<select name="diaIni" class="form-control">
                                        ...
                                        <div class="form-group">
	                                       	<div class="col-lg-4">
	                                        	<label>Año Fin</label>
	                                           	<select name="anoFin" class="form-control">
	                                            	<option>2015</option>
                                       	...
                                       	<div class="col-lg-4">
	                                    	<div class="form-group">
	                                        	<label>Mes Fin</label>
	                                           	<select name="mesFin" class="form-control">
		                                       		<option value="1" selected>Enero</option>
		                                            <option value="2">Febrero</option>
		                                            <option value="3">Marzo</option>
		                                            <option value="4">Abril</option>
                                       	...
                                       	<div class="col-lg-4">
	                                   		<div class="form-group">
	                                        	<label>Día Fin</label>
	                                           	<select name="diaFin" class="form-control">
	                                               	<option value="" selected>seleccione</option>
	                                               	<option value="1" selected>01</option>
	                                               	<option value="2">02</option>
	                                               	<option value="3">03</option>
