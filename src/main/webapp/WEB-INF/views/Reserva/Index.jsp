                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <c:forEach items="${reservas}" var="curr">
                                            <tr class="odd gradeX">
	                                            <td>
	                                            	${curr.idreserva}
	                                            </td>
	                                            ...
	                                            <td>
                                     				<fmt:formatDate value="${curr.fechahora}" pattern="dd/MM/yy"/>	       
	                                            </td>
	                                            <td>
                                     				${curr.estadoreserva}       
	                                            </td>
	                                            <td>
	                                            	<a href='../Reserva/Create/'><i class='fa fa-edit fa-lg' title='Editar'></i>
	                                            	<a href='../Reserva/Details/${curr.idreserva}'><i class='fa fa-list-alt fa-lg' title='Detalle'></i>	                                            
	                                            </td>
                                        	</tr>
                                         </c:forEach>
                                    </tbody>
