...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Informe Histórico de Atención de Mascotas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Filtro de Atención de Mascotas
                        </div>
                        <form:form action="/Anizooft/Informes/Mascota" modelAttribute="mascota" method="post">
	                                            ...
	                                            <select name="idMascota" id="idMascota" class="form-control">
	                                                <option label="(Seleccione)" value="" selected>Seleccione...</option>
			                                           <c:if  test="${!empty mascotas}">
			                                                ...
			                                                <c:choose>
				                                                    <c:when test="${idMascota == mascota.idmascota}">
				                                                    	<option value="${mascota.idmascota}" selected="selected">${mascota.idmascota} - ${mascota.nombre}</option>
				                                                    </c:when>
				                                                    <c:otherwise>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <c:forEach items="${mascotaList}" var="curr">
                                            <tr class="odd gradeX">
	                                            <td>(${curr.rutdueño}) ${curr.nombredueño} ${curr.apellidodueño}</td>
	                                            <td>(${curr.idmascota}) ${curr.nombremascota} ${curr.razamascota}</td>
	                                            <td>(${curr.rutempleado}) ${curr.nombreempleado} ${curr.apellidoempleado}</td>
	                                            <td>${curr.atenciones}</td>
                                        	</tr>
                                         </c:forEach>
                                    </tbody>
                                </table>
